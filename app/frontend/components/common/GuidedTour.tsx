...
const getJoyrideStyles = (isDarkMode: boolean): Partial<Styles> => {
  return {
    options: {
      zIndex: 12000,
      arrowColor: isDarkMode ? 'rgb(var(--brand-primary-deep-rgb) / 1)' : 'rgb(var(--brand-white-rgb) / 1)',
      backgroundColor: isDarkMode ? 'rgb(var(--brand-primary-deep-rgb) / 1)' : 'rgb(var(--brand-white-rgb) / 1)',
      primaryColor: 'rgb(var(--brand-primary-rgb) / 1)',
      textColor: isDarkMode ? 'rgb(var(--brand-accent-surface-rgb) / 1)' : 'rgb(var(--brand-text-rgb) / 1)',
      overlayColor: 'rgb(var(--brand-primary-deep-rgb) / 0.62)',
      width: 380,
      spotlightShadow: '0 0 0 9999px rgb(var(--brand-primary-deep-rgb) / 0.62)',
    },
    tooltip: {
      borderRadius: 14,
      border: isDarkMode ? '2px solid rgb(var(--brand-accent-rgb) / 0.55)' : '2px solid rgb(var(--brand-primary-rgb) / 0.35)',
      boxShadow: '0 14px 42px rgb(var(--brand-primary-deep-rgb) / 0.28)',
      overflow: 'hidden',
    },
    tooltipContainer: {
      textAlign: 'left',
    ...
    buttonNext: {
      backgroundColor: 'rgb(var(--brand-primary-rgb) / 1)',
      borderRadius: 10,
      fontSize: 13,
      fontWeight: 600,
      padding: '8px 14px',
    ...
    buttonBack: {
      color: isDarkMode ? 'rgb(var(--brand-accent-surface-rgb) / 1)' : 'rgb(var(--brand-primary-rgb) / 1)',
      fontSize: 13,
      fontWeight: 600,
      marginRight: 8,
    },
