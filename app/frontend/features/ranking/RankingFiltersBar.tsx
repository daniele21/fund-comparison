...
import type { CapitalGuaranteeFilter, FundCategory } from '../../types';
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
          <select
            ...
            className="min-h-11 rounded-lg border border-slate-200 bg-white px-3 py-2 pr-8 text-sm font-medium text-slate-800 transition-all focus:outline-none focus:ring-2 focus:ring-[rgb(var(--brand-primary-rgb)/1)] dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 sm:min-w-[14rem]"
          >
          ...
          <select
            ...
            className="min-h-11 rounded-lg border border-slate-200 bg-white px-3 py-2 pr-8 text-sm font-medium text-slate-800 transition-all focus:outline-none focus:ring-2 focus:ring-[rgb(var(--brand-primary-rgb)/1)] dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 sm:min-w-[13rem]"
          >
...
const ToggleFilter: React.FC<ToggleFilterProps> = ({ checked, label, onChange }) => {
  return (
    <label className="flex min-h-11 items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
