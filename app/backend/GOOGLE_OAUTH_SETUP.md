...
6. Create OAuth Client ID:
   ...
   - **Authorized redirect URIs**:
     - `http://127.0.0.1:3000` (must match origin for popup mode)
     - `http://localhost:3000`

7. Copy the **Client ID** and **Client Secret**

**Important**: For popup mode, the redirect URI **must be the page origin** (e.g., `http://127.0.0.1:3000`), not a callback path.
...
2. **Open the app**: `http://127.0.0.1:3000`
...
- For popup mode, it must be the page **origin** (e.g., `http://127.0.0.1:3000`), not a path
...
- NOT: `http://127.0.0.1:3000/auth/callback` (frontend URL)
