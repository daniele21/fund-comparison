...
def get_development_config() -> dict:
    ...
    auth_config.oauth_redirect_uri = "http://127.0.0.1:3000/auth/callback"
...
APP_OAUTH_REDIRECT_URI=http://127.0.0.1:3000/auth/callback
...
APP_FRONTEND_BASE_URL=http://127.0.0.1:3000
